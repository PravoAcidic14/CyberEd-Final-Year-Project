...
class SelectiveAdaptiveQuiz extends StatefulWidget {
  final String moduleId;
  final bool isLastScore;
  SelectiveAdaptiveQuiz(
      {Key key, @required this.moduleId, @required this.isLastScore})
      : super(key: key);

  @override
  _SelectiveAdaptiveQuizState createState() => _SelectiveAdaptiveQuizState();
}

class _SelectiveAdaptiveQuizState extends State<SelectiveAdaptiveQuiz> {
          ...
          children: [
            Container(
              child: Padding(
                ...
                child: FutureBuilder(
                    future: _adaptiveLearningController
                        .getAdaptiveQuestionsByModule(widget.moduleId),
                                ...
                                .map((options) => Padding(
                                      ...
                                      child: AppButtons(
                                        onPressed: () {
                                          ...
                                          //check the answer
                                          isAnswered =
                                              _adaptiveLearningController
                                                  .checkAnswer(
                                                      selectedOptionIndex,
                                                      answerIndex);

                                          Timer(Duration(seconds: 1), () {
                                            if (widget.isLastScore == true) {
                                              setState(() {
                                                if (adaptiveSetCount ==
                                                    totalQuestions - 1) {
                                                  _adaptiveLearningController
                                                      .calcScore(modules, true);
